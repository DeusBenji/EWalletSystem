...
{
    public class MitIdAccountDatabaseAccess : IMitIdDbAccess
    {
        ...
        public async Task<Guid> CreateMitIdAccount(MitID_Account mAcc)
        {
            ...
            string queryString = @"INSERT INTO MitID_Account (ID, AccountID, SubID, IsAdult) OUTPUT INSERTED.ID VALUES (@ID, @AccountID, @SubID, @IsAdult);";
        ...
        public async Task<MitID_Account?> GetMitIdAccountByAccId(Guid accId)
        {
            ...
            string queryString = @"SELECT ID, AccountID, SubID, IsAdult FROM MitID_Account WHERE AccountID = @AccountID;";
            using (SqlConnection con = new SqlConnection(_connectionString))
        ...
        { 
            ...
            string queryString = @"SELECT ID, AccountID, SubID, IsAdult FROM MitID_Account;";
        ...
        { 
            ...
            string queryString = @"UPDATE MitID_Account SET AccountID = @AccountID, SubID = @SubID, IsAdult = @IsAdult WHERE ID = @ID;";
        ...
        { 
            ...
            string queryString = @"DELETE FROM MitID_Account WHERE ID = @ID;";
            using (SqlConnection con = new SqlConnection(_connectionString))
